...
function destroyTr() {
    ...
    appUtil.confirmBox('Deseja realmente excluir este Moto?', function(retorno) {
        if (retorno) {
            $.ajax({
...
function configTable() {
    return $('#data_table').DataTable({
        ...
        columns: [
            {data:'modelo', name:'modelo', className:'text-left'},
            {data:'marca', name:'marca', className:'text-left'},
            {data:'ano', name:'ano', className:'text-left'},
